...
import { openBlock, createBlock, renderSlot, createCommentVNode, createVNode, createTextVNode, toDisplayString, withDirectives, vShow, resolveComponent, withCtx, Fragment, renderList, withModifiers, resolveDynamicComponent } from 'vue';
...
var _hoisted_1$1 = /*#__PURE__*/createVNode("span", { class: "default" }, "<", -1 /* HOISTED */);
var _hoisted_2$1 = /*#__PURE__*/createVNode("span", { class: "default" }, ">", -1 /* HOISTED */);

function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  return withDirectives((openBlock(), createBlock("header", null, [
    createVNode("span", {
      ...
      renderSlot(_ctx.$slots, "prevIntervalBtn", {}, function () { return [
        _hoisted_1$1
      ]; })
    ], 2 /* CLASS */),
    ...
    createVNode("span", {
      ...
      renderSlot(_ctx.$slots, "nextIntervalBtn", {}, function () { return [
        _hoisted_2$1
      ]; })
    ], 2 /* CLASS */)
  ], 512 /* NEED_PATCH */)), [
    [vShow, $props.config.showHeader]
  ])
}
...
function render$4(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createBlock("div", _hoisted_1$2, [
    ...
    createVNode(_component_PickerHeader, {
      ...
      nextIntervalBtn: withCtx(function () { return [
        renderSlot(_ctx.$slots, "nextIntervalBtn")
      ]; }),
      prevIntervalBtn: withCtx(function () { return [
    ...
    createVNode("div", {
      ...
      (openBlock(true), createBlock(Fragment, null, renderList($options.daysOfWeek, function (d) {
      ...
      ($options.blankDays > 0)
        ? (openBlock(true), createBlock(Fragment, { key: 0 }, renderList($options.blankDays, function (d) {
            return (openBlock(), createBlock("span", {
              key: d.timestamp,
        ...
        : createCommentVNode("v-if", true),
      (openBlock(true), createBlock(Fragment, null, renderList($options.days, function (day) {
        return (openBlock(), createBlock("span", {
          key: day.timestamp,
...
function render$5(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createBlock("div", _hoisted_1$3, [
    ...
    (openBlock(true), createBlock(Fragment, null, renderList($options.months, function (month) {
      return (openBlock(), createBlock("span", {
        key: month.timestamp,
        class: [{'selected': month.isSelected, 'disabled': month.isDisabled}, "cell month"],
        onClick: withModifiers(function ($event) { return ($options.selectMonth(month)); }, ["stop"])
...
function render$6(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createBlock("div", _hoisted_1$4, [
    ...
    createVNode(_component_PickerHeader, {
      ...
      headerContent: withCtx(function () { return [
        createVNode("span", null, toDisplayString($options.getPageDecade), 1 /* TEXT */)
      ]; }),
      nextIntervalBtn: withCtx(function () { return [
        renderSlot(_ctx.$slots, "nextIntervalBtn")
      ]; }),
    ...
    (openBlock(true), createBlock(Fragment, null, renderList($options.years, function (year) {
      return (openBlock(), createBlock("span", {
        key: year.timestamp,
        class: [{ 'selected': year.isSelected, 'disabled': year.isDisabled }, "cell year"],
        onClick: withModifiers(function ($event) { return ($options.selectYear(year)); }, ["stop"])
...
function render$7(_ctx, _cache, $props, $setup, $data, $options) {
  var _component_DateInput = resolveComponent("DateInput");
  ...
  return (openBlock(), createBlock("div", {
    ...
    createVNode(_component_DateInput, {
      ...
      beforeDateInput: withCtx(function () { return [
        renderSlot(_ctx.$slots, "beforeDateInput")
      ]; }),
      afterDateInput: withCtx(function () { return [
        renderSlot(_ctx.$slots, "afterDateInput")
      ]; }),
      _: 1
    ...
    ($options.isOpen)
      ? (openBlock(), createBlock("div", {
          ...
          (openBlock(), createBlock(resolveDynamicComponent($data.currentPicker), {
            ...
            beforeCalendarHeaderDay: withCtx(function () { return [
              renderSlot(_ctx.$slots, "beforeCalendarHeaderDay")
            ]; }),
            calendarFooterDay: withCtx(function () { return [
              renderSlot(_ctx.$slots, "calendarFooterDay")
            ]; }),
            beforeCalendarHeaderMonth: withCtx(function () { return [
              renderSlot(_ctx.$slots, "beforeCalendarHeaderMonth")
            ]; }),
            calendarFooterMonth: withCtx(function () { return [
              renderSlot(_ctx.$slots, "calendarFooterMonth")
            ]; }),
            beforeCalendarHeaderYear: withCtx(function () { return [
              renderSlot(_ctx.$slots, "beforeCalendarHeaderYear")
            ]; }),
            calendarFooterYear: withCtx(function () { return [
              renderSlot(_ctx.$slots, "calendarFooterYear")
            ]; }),
            nextIntervalBtn: withCtx(function () { return [
              renderSlot(_ctx.$slots, "nextIntervalBtn")
